...
var EmptySchedual_1 = require("./EmptySchedual");
    ...
    function SchedualManager(scheduals, onSchedualEnd) {
        ...
        scheduals.map(function (schedual, i) {
            if (schedual.timeSlots.length == 0) {
                var empty = new EmptySchedual_1.EmptySchedual(schedual.tags, schedual.defaultNextSchedualTag, _this.nextSchedual);
                _this._scheduals.push(empty);
                scheduals[i] = empty.sSettings;
            }
            else {
                _this._scheduals.push(new Schedual_1.Schedual(schedual, _this.nextSchedual));
            }
        });
    }
